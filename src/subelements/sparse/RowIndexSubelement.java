 ...
 *
 */
public class RowIndexSubelement extends AbstractDataElement
{
        private int[] dataObj;
        
        public RowIndexSubelement()
        {
                super(DataType.miINT32);
        }
        
        public RowIndexSubelement(int[] dims)
        {
                this();
                setData(dims);
        }
        ...
        public RowIndexSubelement read(MyDataInputStream in) throws DataTypeException
        {
